...
FRAME = FrameModel(
    ...
    nodes=[
        ...
        Node("P12", "11 Fractal Hypergrammar Compression", "chapter"),
    ...
    edges=[
        ...
        Edge("P10", "P12", "is observed and collapsed by"),
        Edge("P12", "P01", "seeds the next fractal loop of"),
