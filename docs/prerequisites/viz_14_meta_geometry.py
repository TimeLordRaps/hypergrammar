...
FRAME = FrameModel(
    ...
    notes=[
        ...
        "Ch14 planned: existential emotions (form, simultaneously mental/physiological, self-centered grandiose frame, orgasmic euphoric epiphanies, Baader-Meinhof clustering). Not William James. Not Ratcliffe. Not Stimmung. Novel frame."
    ],
)
